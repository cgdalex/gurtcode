...
struct Waypoint { float x; float y; float angle_deg; void (*pre_path)(void);};
...
public: 
  ...
  void drive_with_pursuit_path(const std::vector<Waypoint>& path);  // uses setback = 0
  void drive_with_pursuit_path(const std::vector<Waypoint>& path, float setback);
  void drive_with_pursuit_path(const std::vector<Waypoint>& path, float setback, float drive_max_voltage, float heading_max_voltage);
  void drive_with_pursuit_path(const std::vector<Waypoint>& path, float setback, float drive_max_voltage, float heading_max_voltage, float drive_settle_error, float drive_settle_time, float drive_timeout);
  void drive_with_pursuit_path(const std::vector<Waypoint>& path, float setback, float drive_max_voltage, float heading_max_voltage, float drive_settle_error, float drive_settle_time, float drive_timeout, float drive_kp, float drive_ki, float drive_kd, float drive_starti, float heading_kp, float heading_ki, float heading_kd, float heading_starti);
};